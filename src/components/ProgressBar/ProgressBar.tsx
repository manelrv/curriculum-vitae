  ...
  return (
    ...
    >
      <div
        ...
        }%] bg-gradient-to-r from-primary to-secondary rounded absolute right-0  transition-all duration-500 ease-in-out'`}
      ></div>
      <div
      ...
      >
        {professionalExperienceItems.map((item, index) => (
          <div
            ...
            className={`h-6 w-6 bg-primary rounded-full cursor-pointer z-10 border-2 ${
              currentItem <= index
